...
Статус: принято для среза G0-01 roadmap GigaLoom 23 июля 2026 года.
...
Поля машинного API и CLI остаются читаемыми во время миграции G0/G1/G2:
...
G1 и G2 могут использовать этот контракт, но не должны вводить собственные
