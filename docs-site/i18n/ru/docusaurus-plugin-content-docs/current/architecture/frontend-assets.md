# Сборка ресурсов веб-интерфейса

Статус: принято 28 июля 2026 года.

Реализация: сборщик ресурсов добавлен 28 июля 2026 года. Скомпилированные
пакеты не хранятся в Git. Исходный код и тесты определяют воспроизводимую
сборку, проверку ресурсов со стороны Python, передачу между заданиями CI,
содержимое sdist, отчёты SBOM и лицензий, а также порядок отката.
