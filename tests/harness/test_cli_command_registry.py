...
def test_cli_error_mapping_is_import_light():
    result = _run_isolated_script(
        ...
        unknown_provider = type(
            ...
            (Exception,),
            {"__module__": "gpt2giga_harness.provider_settings"},
        )("fixture")
        ...
        provider_conflict = type(
            ...
            (Exception,),
            {"__module__": "gpt2giga_harness.provider_registry"},
        )("revision")
        integration_error = type(
            "IntegrationFlowError",
            (Exception,),
            {"__module__": "gpt2giga_harness.integration_flows"},
        )("conflict")
...
def test_non_ui_domain_imports_defer_ui_frameworks():
    result = _run_isolated_script(
        ...
        import gpt2giga_harness.doctor
        import gpt2giga_harness.performance_baseline
        import gpt2giga_harness.tui.commands
        import gpt2giga_harness.ui.local_access
