...
from gigaloom.tui.i18n import translator
...
from gigaloom.tui.widgets.timeline import TimelinePanel
...
def __getattr__(name: str) -> Any:
    ...
    if name in {"FilePickerScreen", "SessionBrowserScreen"}:
        from gigaloom.tui.screens import browsers

        value = getattr(browsers, name)
    elif name in {"ContextDrawerScreen", "ResourceDrawerScreen"}:
        from gigaloom.tui.screens import drawers
...
def _new_run_action_binding(
    *,
    ...
    from gigaloom.tui.client import RunActionBinding
...
class WorkbenchTui(App[None]):
    ...
    async def action_sessions(self) -> None:
        from gigaloom.tui.screens.browsers import SessionBrowserScreen
    ...
    def _session_binding(session: SessionSummary) -> SessionActionBinding:
        from gigaloom.tui.client import session_action_binding
    ...
    def action_context_drawer(self) -> None:
        from gigaloom.tui.screens.drawers import ContextDrawerScreen
    ...
    async def action_tasks(self) -> None:
        from gigaloom.tui.screens.drawers import ResourceDrawerScreen
    ...
    async def _file_query_chosen(self, value: str | None) -> None:
        from gigaloom.tui.screens.browsers import FilePickerScreen
