...
from gigaloom.providers.ports import (
    NetworkAccessTicket,
    ScopedNetworkRequest,
)
from gigaloom.secrets import SecretResolutionService


OPENAI_UPSTREAM_EXECUTION_OWNER = "provider-execution:openai-compatible"
_GATEWAY_ADAPTER_MODULE = "gpt2giga.providers.openai_compatible"
...
def build_openai_compatible_upstream_adapter(
    ...
    *,
    ...
    try:
        adapter_module = import_module(_GATEWAY_ADAPTER_MODULE)
