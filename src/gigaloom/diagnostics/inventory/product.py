...
from gigaloom.integration_sdk import integration_sdk_policy_to_dict
from gigaloom.native import HarnessInvocationMode
from gigaloom.diagnostics.inventory.capabilities import capability_manifest
    ...
    *,
    ...
    document: dict[str, Any] = {
        ...
        "readiness": {
            ...
            "doctor_consumer": {
                "report_kind": "gigaloom_doctor_report",
...
def load_product_inventory() -> dict[str, Any]:
    ...
    resource = resources.files("gigaloom").joinpath(PRODUCT_INVENTORY_RESOURCE)
