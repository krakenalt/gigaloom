...
from gigaloom.projects.api import load_project_config, resolve_project
from gigaloom.runtime.network_access import network_access_manifest
from gigaloom.tools.mcp.api import HeadlessManagedMCPSnapshotStore
...
def _ui_identity_check(
    ...
    if _is_loopback_host(config.ui_host):
        try:
            from gigaloom.ui.local_access import LocalUIAccessStore
    ...
    try:
        from gigaloom.ui.remote_identity import RemoteOIDCSettings
