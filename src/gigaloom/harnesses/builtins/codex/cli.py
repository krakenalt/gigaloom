...
from gigaloom.harnesses.adapter_parity import codex_adapter_capabilities
...
from gigaloom.harnesses.builtins.codex.config import (
...
from gigaloom.harnesses.builtins.codex.streaming import (
    _CodexStreamParser,
    _adapter_version,
)

CodexCliHarness.__module__ = "gigaloom.harnesses.codex_cli"
