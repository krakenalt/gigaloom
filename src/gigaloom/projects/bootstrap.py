...
from gigaloom.sessions import locking as session_locking
...
BOOTSTRAP_PREVIEW_KIND = "gigaloom_bootstrap_preview"
BOOTSTRAP_APPLICATION_KIND = "gigaloom_bootstrap_application"
