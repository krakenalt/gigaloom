...
from gpt2giga_harness.harnesses.builtins.gemini.execution import (
    _adapter_version,
...
from gpt2giga_harness.harnesses.builtins.gemini.streaming import (
    GeminiStreamParser,
)

_GeminiStreamParser = GeminiStreamParser

GeminiCliHarness.__module__ = "gpt2giga_harness.harnesses.gemini_cli"
