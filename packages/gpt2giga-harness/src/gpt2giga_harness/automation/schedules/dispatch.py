...
from gpt2giga_harness.projects.api import HarnessProject, resolve_project
from gpt2giga_harness.automation.ports import run_to_dict
...
class ScheduleDispatchMixin:
    ...
    def _sync_occurrences(self) -> None:
        ...
        from gpt2giga_harness.automation.ports import TERMINAL_JOB_STATUSES
        from gpt2giga_harness.automation.workflows.api import WorkflowRepository
