...
from gpt2giga_harness.diagnostics.performance.workloads import workload_contracts
from gpt2giga_harness.registry import create_default_registry

from .reports import REPORT_ARTIFACT_MAX_BYTES, write_performance_report
...
def run_performance_baseline(
    *,
    ...
    if profile == "local-detail":
        from gpt2giga_harness.diagnostics.performance.workloads.sessions.profile import (
