...
from gpt2giga_harness.contracts.harness import HarnessContext
from gpt2giga_harness.contracts.providers import GigaChatApiMode, parse_api_mode
from gpt2giga_harness.core.config import (
    DEFAULT_CHAT_MODEL,
...
HarnessConfig.__module__ = "gpt2giga_harness.config"
pass_model_env_note.__module__ = "gpt2giga_harness.config"
