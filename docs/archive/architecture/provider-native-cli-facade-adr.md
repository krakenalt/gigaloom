...
[native agent terminal ownership ADR](https://github.com/krakenalt/gigaloom/blob/main/docs/archive/release/adr/2026-07-31-native-agent-terminal-ownership-dynamic-profiles.md).
